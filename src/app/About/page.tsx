...
const About = () => {
  return (
    <section className="h-screen bg-gradient-to-r from-blue-50 to-indigo-50 ">
        <div className="max-w-4xl mx-auto text-center mb-12 pt-20">
          <h2
            className="text-5xl font-extrabold text-indigo-700 mb-6 transform hover:scale-105 transition-transform duration-500"
          >
            About Us
          </h2>
